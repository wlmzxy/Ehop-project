...
%>
      ...
      <div style="text-align:right; margin:5px 10px 5px 0px"><a href="indexservlet">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a href="goodsservlet?type=goods&cid=<%=goods.getCid()%>&pageIndex=<%=pageIndex%>">&nbsp;<%=category.getCname() %></a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;<%=goods.getGtitle() %></div>
          ...
          <td><img src="ad/page_ad.jpg" width="645" height="84" />
		    ...
		    <table width="100%%" border="0" cellspacing="0">
              <tr>
				...
				<div style="text-align:center; margin-top:25px"><a href="gouwucheservlet?cid=<%=goods.getCid()%>&pageIndex=<%=pageIndex%>&gid=<%=goods.getGid()%>"><img src="images/buybutton.gif" border="0" /></a></div>
				</td>
