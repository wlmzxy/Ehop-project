          ...
          <td><img src="ad/page_ad.jpg" width="645" height="84" />
		    ...
		    <table width="100%%" border="0" cellspacing="0">
              <tr>
				...
				<div style="text-align:center;width:40%;height:20px; margin:10px auto;border:red solid 1px;"><a href="gouwucheservlet?cid=<%=goods.getCid()%>&gid=<%=goods.getGid()%>"><img src="images/buybutton.gif" border="0" /></a></div>
				</td>
