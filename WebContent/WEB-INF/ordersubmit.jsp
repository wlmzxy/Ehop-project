          ...
          <td><table width="100%" border="0" cellspacing="0">
              <tr>
                <td><img src="images/buy3.gif" width="635" height="38" />
                  <p>早上好：<%=user.getUloginid() %><%if(user.getUsex().equals("男")){ %>先生<%}else{ %>女士<%} %>！您的购买流程还有最后一步啦</p></td>
              </tr>
              <tr>
                <td><table cellspacing="1" class="carttable">
                 ...
                 <%if(cookie!=null){
                  ...
                  <%}} %>
				   ...
				   <p>收货地址：<%=user.getUaddress() %><br/>
				   收货人：<%=user.getUloginid() %><br/>
				   联系方式：<%=user.getUtel() %></p>
				   
				    <hr/> 
				   <p style="text-align:center"><%if(cookie!=null){ %><a href="ordersuccessservlet?sum=<%=sum%>"><img src="images/finalbutton.gif" width="204" height="51" border="0" /></a><%}else{ %><img src="images/finalbutton.gif" width="204" height="51" border="0"onclick="alert('订单为空,不能确定提交!')" /><%} %></p></td>
              </tr>
            </table></td>
        </tr>
      </table></td>
